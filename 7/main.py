# добавим врагов и обработку столкновений
import pygame as pg
from sprites import *
from config import * 
import sys
...
class Game:
    def __init__(self):
        ...
        self.enemy_spritesheet = Spritesheet('img/enemy.png')  # подгружаем спрайты врагов
    ...
    def createTilemap(self):    
        for i,row in enumerate(tilemap):
            for j, column in enumerate(row):
                ...
                if column == 'E': Enemy(self,j,i) # отрисовываем врагов
