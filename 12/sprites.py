        ...
        if direction == 'x':
            ...
            if hits: 
                if self.x_change>0: 
                    ...
                    for sprite in self.game.all_sprites: # эти две строки чинят камеру
                        sprite.rect.x += PLAYER_SPEED # эти две строки чинят камеру
                if self.x_change<0: 
        ...
        if direction == 'y':
            ...
            if hits: 
                if self.y_change>0: 
                    ...
                    for sprite in self.game.all_sprites:# эти две строки чинят камеру
                        sprite.rect.y += PLAYER_SPEED# эти две строки чинят камеру
                if self.y_change<0:
...
class Attack(pg.sprite.Sprite):
    ...
    def animate(self):
        ...
        if direction == 'down':
            ...
            if self.animation_loop>=5:self.kill()
        if direction == 'up':
            self.image = up_animations[math.floor(self.animation_loop)]
            self.animation_loop+=0.5
            if self.animation_loop>=5:self.kill()
